...
public class PdeExternalAnnotator extends ExternalAnnotator<PsiFile, List<PdeExternalAnnotator.Issue>> {
    ...
    public List<Issue> doAnnotate(final PsiFile file) {
        Collection<? extends PsiElement> funcNameNodes =
                XPath.findAll(PdeLanguage.INSTANCE, file, "/script/function/ID");
        Collection<? extends PsiElement> funcCallNameNodes =
                XPath.findAll(PdeLanguage.INSTANCE, file, "//call_expr/ID");
