...
public class PdePluginController implements ProjectComponent {
    public static final String PLUGIN_ID = "org.antlr.jetbrains.sample"; // TODO
    public static final Logger LOG = Logger.getInstance("SamplePluginController"); // TODO

    public Project project;
    public boolean projectIsClosed = false;

    public PdePluginController(Project project) {
